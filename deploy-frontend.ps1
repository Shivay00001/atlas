# Atlas Frontend Deployment Script
param(
    [switch]$Dev = $false,
    [switch]$Prod = $false,
...
Write-Info "Atlas Frontend Deployment"
Write-Host "========================="
Write-Host ""
...
if ($Prod -and (Test-Path "$FrontendDir\dist")) {
    ...
    Write-Info "Serving production build on port 3001..."
    ...
    Write-Info "Starting development server on port 3001..."
    npm run dev
}
